...
elements = np.array([semi_major_1[cut_off],semi_major_2[cut_off],semi_major_3[cut_off],mag_ecc_1[cut_off],mag_ecc_2[cut_off],mag_ecc_3[cut_off],inclination_1[cut_off],inclination_2[cut_off],inclination_3[cut_off],mean_anomaly_1[cut_off],mean_anomaly_2[cut_off],mean_anomaly_3[cut_off],raan_1[cut_off],raan_2[cut_off],raan_3[cut_off],arg_per_1[cut_off],arg_per_2[cut_off],arg_per_3[cut_off],linregress(times, semi_major_1).slope,linregress(times, semi_major_2).slope,linregress(times, semi_major_3).slope])
print('elements')
print(elements.T)
...
np.savetxt('elements_from_Cartesian.dat',elements.T,header = header)
